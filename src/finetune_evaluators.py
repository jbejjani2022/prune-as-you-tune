...
class BertBaseFineTuneEvaluator(FineTuneEvaluator):
    def __init__(self, dataset, training_args, lora_config, pruning_method, max_length, device):
        model_name = 'bert-base-uncased'
        super().__init__(model_name, dataset, training_args, lora_config, pruning_method, max_length, device)
